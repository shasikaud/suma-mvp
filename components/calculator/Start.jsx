...
const Start = ({ updateUserData }) => {
  return (
    <div className="flex flex-col w-full gap-2 pl-8">
        ...
        <button className="flex justify-center text-slate-50 bg-primary px-6 py-3 rounded-2xl mt-6 mr-auto text-center transition hover:bg-primaryHover" onClick={e => {updateUserData('state', 'COMPANY_OVERVIEW')}}>
          Start Now
        </button>
    </div>
  )
